...
boxplot(gmes~treatment, gmes, ylab=gmlab,names=FALSE, ylim=c(0,.55), outline=FALSE)
...
boxplot(mean_gs~treatment, gmes, ylab=condlab,names=FALSE, ylim=c(0,.55), outline=FALSE)
mtext(aclc, side=1,at=1, line=2.5, cex=.7)
mtext(acuc, side=1,at=2, line=2.5, cex=.7)
mtext(eclc, side=1,at=3, line=2.5, cex=.7)
mtext(ecuc, side=1,at=4, line=2.5, cex=.7)
...
boxplot(Photo~treatment, gmes, ylab=photolab,names=FALSE, ylim=c(0,25), outline=FALSE)
mtext(aclc, side=1,at=1, line=2.5, cex=.7)
mtext(acuc, side=1,at=2, line=2.5, cex=.7)
mtext(eclc, side=1,at=3, line=2.5, cex=.7)
mtext(ecuc, side=1,at=4, line=2.5, cex=.7)
...
dev.copy2pdf(file= "output/phys_box.pdf")
dev.off()
